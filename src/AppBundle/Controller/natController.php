...
{
	public function grupos_natAction()
	{
		$u = $this->getUser();
		if($u != null)
		{
	        ...
	        if($role == "ROLE_SUPERUSER")
	        {
				...
				return $this->render("@App/nat/grupos_nat.html.twig", array(
					"grupo"=>$grupos
				));
	        }
	        if($role == "ROLE_ADMINISTRATOR" or $role == "ROLE_USER")
	        	return $this->redirectToRoute("lista_nat");
	    }
	}

	public function lista_natAction()
	{
	...
	public function registro_aclAction()
	{
		$plantel=$_REQUEST['id'];
